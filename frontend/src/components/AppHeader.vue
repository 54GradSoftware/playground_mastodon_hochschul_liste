...
const items = computed(() => [
  {
    ...
    hasSubmenu: true,
    items: lists
      .filter((list) => list.category === 'Wissenschaft')
      .map((list) => ({
  ...
  },
  {
    ...
    hasSubmenu: true,
    items: lists
      .filter((list) => list.category === 'Öffentliche Verwaltung (DE)')
      .map((list) => ({
        label: t('lists.' + list.key),
  ...
  },
  {
    ...
    hasSubmenu: true,
    items: lists
      .filter((list) => list.category === 'Weitere')
      .map((list) => ({
        label: t('lists.' + list.key),
  ...
  },
  {
    ...
    hasSubmenu: true,
    items: lists
      .filter((list) => list.category === 'Niederlande (NL)')
      .map((list) => ({
        label: t('lists.' + list.key),
  ...
  },
  {
    ...
    hasSubmenu: true,
    items: lists
      .filter((list) => list.category === 'PeerTube')
      .map((list) => ({
        label: t('lists.' + list.key),
